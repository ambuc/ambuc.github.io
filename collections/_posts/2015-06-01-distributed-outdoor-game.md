...
The first bit was known to the user; the second was not. The second bit was easy
...
**Finds between Zones.** Each find is a very light red line. The more inter-zone
